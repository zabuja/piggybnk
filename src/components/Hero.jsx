  ...
  return (
    <div className="hero">
      ...
      <div className="sub-heading">TOOLS FOR EVERYONE</div> 
        ...
        <div className="sub">
          Trade capital efficient option spreads. Traders just need to post the
          max loss possible and Otus handles the rest.
        </div>
        </div>
        <div className="box">
        <div className="heading">Provide Liquidity</div>
        <div className="sub">
          Earn fees from option spread traders, no withdrawal fees, capital is
        ...
        <div className="sub">
          Execute multi leg trades on Lyra and other platforms in 1 click with
          Otus.
        </div>
        </div>
        <div className="box">
