    ...
    <>
      <div className='navbar'>
        <ul className='navlist'>
            ...
            <li className='list-item link'><a href="#discord">Discord</a></li>
            <li className='list-item link'><a href="#twitter">Twitter</a></li>
            </div>
            <div className="right-side">
            <li className='list-item' ><button className='btn'><a href="#twitter">Launch App</a></button></li>
            <li onClick={() => setToggle(prev => !prev)} className="hamburger">
              {toggle ? <Cross /> : <Hamm />}
            </li>
            </div>
        </ul>
